    ...
    <div className="timeline-controls">
      <div className="controls-section">
        ...
        <div className="measure-controls">
          ...
          <button
            ...
            disabled={isSpectator || measureCount <= 1}
          ...
          <button
            className="measure-btn"
            disabled={isSpectator || measureCount >= 4}
      ...
      <div className="controls-section">
        ...
        <button
          ...
          } ${isSpectator ? "transport-btn--spectator-disabled" : ""}`}
          onClick={() => !isSpectator && setSnapToGrid(!snapToGrid)}
        ...
        {/* BPM Control */}
        <div className={`bpm-control ${isSpectator ? "bpm-control--spectator-disabled" : ""}`}>
